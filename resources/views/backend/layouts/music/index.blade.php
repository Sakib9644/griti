    ...
    <div class="side-app">
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.workout_videos.index') }}">Workout Videos</a></li>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-options">
                                <a href="{{ route('admin.music.create') }}" class="btn btn-primary btn-sm">Add New Music</a>
                            </div>
                        </div>
                        <div class="card-body">
                                        ...
                                        @forelse($music as $index => $m)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route('admin.music.destroy', $m->id) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('Are you sure you want to delete this music?');">
                                                        @csrf
                                                        @method('DELETE')
