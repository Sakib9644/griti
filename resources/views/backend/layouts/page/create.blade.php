                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="file"
                                                        ...
                                                        data-default-file="{{ url('default/logo.png') }}" name="icon"
                                                        id="icon">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control @error('content') is-invalid @enderror description" name="content" placeholder="Content"
                                                        id="description" rows="6">{{ old('content') }}</textarea>
                                                    @error('content')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        name="meta_title" placeholder="Meta Title" id=""
                                                ...
                                                <div class="form-group">
                                                    <label for="meta_description" class="form-label">Meta
                                                        Description:</label>
                                                    <textarea class="form-control @error('content') is-invalid @enderror" name="content" placeholder="Content"
                                                        id="description" rows="6">{{ old('content') }}</textarea>
