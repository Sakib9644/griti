...
class UserController extends Controller
{
    ...
    public function me()
    {
        ...
        $data = [
            ...
            'user_info' => [
                ...
                'total_workoutsCompleted' => $totalWorkouts,
    ...
    public function updateProfile(Request $request)
    {
        $validatedData = $request->validate([
            ...
            // Age now will be converted to date
        ...
        $userInfoFields = ['age', 'current_weight', 'height', 'target_weight'];
        $userInfoData = array_intersect_key($validatedData, array_flip($userInfoFields));

        // ✅ Convert age integer → date before saving
